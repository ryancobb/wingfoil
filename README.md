...
Sunbreak Bay targets the sunny arcade energy of *Wave Race 64* and the graphic nautical world of *The Wind Waker*: saturated blue water, cream foam contours, scalloped clouds, stepped grassy cliffs, palms, orange equipment, and a bold cream-and-gold HUD. Three-band toon lighting keeps the rider and wing readable. A slight speed-dependent camera widening, hull wake, and pooled spray reinforce acceleration.

The ocean uses a dense local wave mesh and a lightweight distant ring. The surface displacement, lighting slopes, crest foam, buoyancy, foil flow, wakes, and floating course buoys share the wave definition in `src/water.js`. Waves and floating buoys share the same fade to the flat distant ring at the mesh boundary. Spray strengthens on water impacts and carving, while the foiling trail is lighter. Thin, broken crest foam is antialiased per pixel and fades with distance; restrained glints and underwater gear remain visible. The **Waves** setting ranges from flat water through the default rolling swell to rough seas; approaching waves at different angles changes the ride. Changing wave strength preserves board clearance and vertical motion relative to the water. Scenery is procedural, with instanced palms and shrubs, and requires no external textures.
